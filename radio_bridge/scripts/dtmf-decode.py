...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Decode DTMF sequence in a provided .wav file")
    parser.add_argument(
        "--path", type=str, help="Path where the recording is stored", required=True
    )
    parser.add_argument(
        "--implementation", type=str, help="Which decode implementation to use", default="fft_1"
    )
